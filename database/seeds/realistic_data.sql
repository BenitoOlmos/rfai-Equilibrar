...
(
  ...
  1,
  1,
  DATE_SUB(CURDATE(), INTERVAL 2 DAYS),
  DATE_SUB(CURDATE(), INTERVAL 2 DAYS),
  60,
  'REALIZADA',
...
(
  ...
  2,
  2,
  DATE_ADD(CURDATE(), INTERVAL 5 DAYS),
  NULL,
  60,
  'PROGRAMADA',
...
(
  ...
  1,
  1,
  DATE_SUB(CURDATE(), INTERVAL 21 DAYS),
  DATE_SUB(CURDATE(), INTERVAL 21 DAYS),
  60,
  'REALIZADA',
...
(
  ...
  2,
  2,
  DATE_SUB(CURDATE(), INTERVAL 14 DAYS),
  DATE_SUB(CURDATE(), INTERVAL 14 DAYS),
  60,
  'REALIZADA',
...
(
  ...
  3,
  3,
  DATE_SUB(CURDATE(), INTERVAL 7 DAYS),
  DATE_SUB(CURDATE(), INTERVAL 7 DAYS),
  60,
  'REALIZADA',
...
(
  ...
  1,
  1,
  DATE_SUB(CURDATE(), INTERVAL 10 DAYS),
  DATE_SUB(CURDATE(), INTERVAL 10 DAYS),
  60,
  'REALIZADA',
...
(
  ...
  2,
  2,
  DATE_ADD(CURDATE(), INTERVAL 2 DAYS),
  NULL,
  60,
  'PROGRAMADA',
  NULL,
